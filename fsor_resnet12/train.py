...
model_pool = ['ResNet18','ResNet12','WRN28', 'ResNet50', 'vit-small']
...
if __name__ == "__main__":
    ...
    elif args.featype == 'GOpenMeta':
        open_train_val_loader, meta_test_loader, n_cls = get_dataloaders(args,'gopenmeta')
        dataloader_trainer = (open_train_val_loader, None, n_cls)
        args.base_size = n_cls if args.base_size == -1 else args.base_size
        trainer = GMetaTrainer(args,dataloader_trainer,meta_test_loader)  
        trainer.train(meta_test_loader) 
